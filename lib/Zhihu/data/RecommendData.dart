...
//
//     final recommendData = recommendDataFromJson(jsonString);

import 'dart:convert';

RecommendData recommendDataFromJson(String str) => RecommendData.fromJson(json.decode(str));

String recommendDataToJson(RecommendData data) => json.encode(data.toJson());
...
class RecommendDataData {
  ...
  factory RecommendDataData.fromJson(Map<String, dynamic> json) => RecommendDataData(
